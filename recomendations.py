...
recomendations = [
    ...
    "It Is Recomended, That File Should Not Have Vulnarability And Directly Accessible Without Login. \n\t\t Security Review For New File Is Is Essential. \n\t\t For More: https://www.youtube.com/watch?v=dRYy6gJBmyM",
    "File",
    "500",
    "Manual"
    ],
    ...
    "It Is Recommended, To Go With Security Review And Do Not Relay On Third Party Or Free Code.",
    "3rd Party",
    "500",
    "Auto,Manual"
    ], 
    ["Directory Traversal",
    "Any File Name Or File Parameters Are Passed Through Any Request Parameters. \n\t\t Like Get/Post/Request ? Or File Path Is Stored In Local Storage Or Cookie For Further Use? \n\t\t eg: example.com/somefile.php?file=abc.txt",
